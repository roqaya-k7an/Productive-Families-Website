...
<html lang="en">
  <head>
    ...
    <title>Productive Families | Add address</title>
...
?>
  ...
  width: 100%; " >
                    ...
                    <input type="text" value="<?php echo htmlentities($row['street']);?>" placeholder="street" name="street">
                     <label for="">location<span>*</span></label>
                    <input type="url" value="<?php echo htmlentities($row['location']);?>" placeholder="location" name="location" required style=" border: 1px solid #ccc;
  color: #999;
  height: 40px;
  padding: 10px;
  width: 100%; ">
                    ...
                    <input type="text" placeholder="properties" value="<?php $clientid=$_SESSION['clientid']; echo$clientid ?>" name="clientid">
...
$sql="update clientaddress set city='$city',street='$street',location='$location' where clientid='$clientid'";
	mysqli_query($con,$sql);
	echo "<script>alert('Successfully update address ');</script>";
