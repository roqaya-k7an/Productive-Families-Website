...
<p align="center">
  <img src="https://img.shields.io/badge/🏆%20First%20Place-Female%20Section%20Graduation%20Projects-FFD700?style=for-the-badge&labelColor=B8860B" alt="First Place Award">
</p>

<p align="center">
  <strong>🥇 Awarded First Place among the Female Section graduation projects</strong><br>
...
| :---: | :---: | :---: |
| ![Manage Products](docs/screenshots/manage-products.jpg) | ![Add Product](docs/screenshots/add-product.jpg) | ![Edit Product](docs/screenshots/edit-product.jpg) |

### Orders & Requests
| Current Demand | Incoming Requests |
| :---: | :---: |
| ![Current Demand](docs/screenshots/current-demand.jpg) | ![Incoming Requests](docs/screenshots/incoming-requests.png) |

### Client Experience
| Browse Products | Shopping Cart | My Requests |
| :---: | :---: | :---: |
| ![Client Products](docs/screenshots/client-products.jpg) | ![Cart](docs/screenshots/cart.jpg) | ![Client Requests](docs/screenshots/client-requests.png) |

### Delivery Agent
| Agent Dashboard | Delivery Requests |
| :---: | :---: |
| ![Delivery Agent](docs/screenshots/delivery-agent.png) | ![Agent Requests](docs/screenshots/agent-requests.jpg) |
