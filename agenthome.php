...
<html lang="en">
  <head>
    ...
    <title>Productive Families |Delivery Agent Page</title>
...
$result = mysqli_query($con,"SELECT * FROM agentcar where agentno='$agentid' ")
or die(mysqli_error());
...
?>
                    <tbody>
                      <tr>
                        ...
                        <td><a class="aa-cart-title" href="#"><?php echo htmlentities($row['kind']);?></a></td>
                        <td><?php echo htmlentities($row['color']);?></td>
                        <td> <?php echo htmlentities($row['model']);?></td>
                         <td><a href="#"><img src="<?php echo htmlentities($row['carimage']);?>" width="50"  height="50" alt="img"></a></td>
                          <td><?php echo htmlentities($row['carnumber']);?></td>
                          
                          <td><a class="remove" onclick='javascript:confirmationDelete($(this));return false;' href="delcar.php?carid=<?php echo htmlentities($row['carid']);?>"><fa class="fa fa-close"></fa></a></td>
                       <script>
function confirmationDelete(anchor)
{
   ...
   if(conf)
      window.location=anchor.attr("href");
                           ...
                           <td><a class="aa-browse-btn" href="editcar.php?carid=<?php echo htmlentities($row['carid']);?>">Edit</a></td>
...
?>
                   ...
                   <a href="Addcar.php" class="aa-browse-btn" > Add car </a>
...
require 'config.php';
$agentid=$_SESSION['agentid'] ;
$result = mysqli_query($con,"SELECT * FROM deliverydemand where agentid='$agentid' ")
or die(mysqli_error());
...
?>
                    <tbody>
                      <tr>
                        ...
                        <td><a class="aa-cart-title" href="#"><?php echo htmlentities($row['deno']);?></a></td>
                        <td><?php echo htmlentities($row['demandno']);?></td>
                        <td><?php echo htmlentities($row['clientid']);?> </td>
                         ...
                         <td><a href="viewcurrentdemandagent.php?demandno=<?php echo htmlentities($row['demandno']);?>&clientid=<?php echo htmlentities($row['clientid']);?>&proid=<?php echo htmlentities($row['proid']);?>" class="aa-add-to-cart-btn">View</a></td>
                      </tr>
                       <?php
}
...
?>
                      <thead>
                        <tr>
                          <th><?php echo '<span class="color">' . $row['agentid'] . '</span>'; ?></th>
                          <th>Number</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td> <strong><?php echo '<span class="color">' . $row['agentname'] . '</span>'; ?>  </strong></td>
                          <td>Name </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td> <strong> <?php echo '<span class="color">' . $row['kind'] . '</span>'; ?></strong></td>
                          <td>sex</td>
                        </tr>
                        <tr>
                          <td> <strong> <?php echo '<span class="color">' . $row['nationality'] . '</span>'; ?></strong></td>
                          <td>Nationality</td>
                        </tr>
                      </tbody>
                      ...
                      <div class="aa-payment-method" > 
                          <table class="table table-responsive">
                          <tr align="center"><td>
                      <a href="editagentdata.php?agentid=<?php echo htmlentities($row['agentid']);?>" class="aa-browse-btn">Edit Information</a></td>
                      <td>
                    <a href="signout.php?agentid=<?php echo htmlentities($row['agentid']);?>" class="aa-browse-btn">Logout</a></td> </tr></table>
