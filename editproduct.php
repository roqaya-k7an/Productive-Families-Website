...
?>
 ...
 <section id="aa-myaccount">
        ...
        <div class="aa-myaccount-area">         
            <div class="row">
              <div class="col-md-6">
                ...
                <h4>Edit Product</h4>
                              <form action="uploadphotoproductedit.php" enctype="multipart/form-data" method="post" class="aa-login-form">
  ...
  width: 100%; " >
                    ...
                    <input type="text" value="<?php echo htmlentities($row['price']);?>" placeholder="Price" name="price">
                     ...
                     <div class="form-group">                        
                      <textarea class="form-control" rows="3" name="summary" placeholder="summary"><?php echo htmlentities($row['discribe']);?></textarea>
                    </div>
                                  <label for="">Image<span>*</span></label>
                   <input type="file" value="<?php echo htmlentities($row['image']);?>" placeholder="Model" name="file" style=" border: 1px solid #ccc;
  color: #999;
  height: 40px;
  padding: 10px;
  width: 100%; " multiple>
                    ...
                    <input type="text" value="<?php echo htmlentities($row['properties']);?>" placeholder="properties" name="properties">
  ...
  padding: 10px;
  width: 100%; " >
                                  <option value="<?php echo htmlentities($row['preset']);?>"><?php echo htmlentities($row['preset']);?></option>
                    ...
                    <button type="submit" name="add" class="aa-browse-btn">Edit product</button>  
              ...
              <div class="col-md-6">
                <div class="aa-myaccount-register"> 
                    <br>
                 <img src="<?php echo htmlentities($row['image']);?>" width="500" height="500"  >
                </div>
                   <?php
}
