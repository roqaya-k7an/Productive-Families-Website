                  ...
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-prod-quantity">              
                      <p class="aa-prod-category">
                        ...
                        <p class="aa-prod-category">
                        Client name: <a href="#"><?php echo htmlentities($row['clientname']);?></a>
                      </p>
                        <p class="aa-prod-category">
                        ClientId: <a href="#"><?php echo htmlentities($row['clientid']);?></a>
                      </p>
                         <p class="aa-prod-category">
                        Accept: <a href="#"><?php echo htmlentities($row['accept']);?></a>
                      </p>
                    ...
                    <div class="aa-prod-view-bottom">
                      <a class="aa-add-to-cart-btn" href="editstatus.php?demandno=<?php echo htmlentities($row['demandno']);?>">Update Status</a>
                      <a class="aa-add-to-cart-btn" href="deldemandpro.php?demandno=<?php echo htmlentities($row['demandno']);?>">cancel</a>
