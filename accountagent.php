...
<html lang="en">
 ...
 <section id="aa-myaccount">
  ...
  width: 100%; " >
                                  ...
                                  <option value="1">ARAR</option>
                                  <option value="2">Riyade</option>
                                  <option value="3"> Macca</option>
                                  <option value="4">El Madena</option>
  ...
  width: 100%; "  >
                    ...
                    <input type="tel" placeholder="Enter correct phone number" name="phone" pattern="[05]{2}[0-9]{4}[0-9]{4}" required style=" border: 1px solid #ccc;
  color: #999;
  height: 40px;
  padding: 10px;
  width: 100%; ">
  ...
  width: 100%; " >
                    ...
                    <input type="password" placeholder="Password" name="password" required minlength="8" data-msg="Password is not less than 8 characters">
...
$password=$_POST['password'];
  ...
  $_SESSION['agentname'] =$name; 
$sql="INSERT INTO deliveryagent (agentname,city,kind,nationality,phoneno,username,password) VALUES 
    ('$name','$city','$kind','$nat','$phone','$username','$password')";
