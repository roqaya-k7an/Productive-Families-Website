              ...
              <div class="col-md-6">
                <div class="aa-myaccount-register">                 
                 ...
                 <form method="post" action="" class="aa-login-form">
                    ...
                    <input type="text" placeholder="name"  value="<?php echo htmlentities($row['adname']);?>" name="name" required >
...
$sql="update admin set adname='$name',phoneno='$phone',username='$username',password='$password' where adno='$adno'";
