            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="aa-myaccount-register">                 
                 <h4>Productive family Register</h4>
  ...
  width: 100%; " >
                    ...
                    <input type="text" placeholder="name" name="name" required>
                     ...
                     <div class="form-group">                        
                      <textarea class="form-control" rows="3" placeholder="summary" name="summary"></textarea>
                    </div>
...
$sql="INSERT INTO profamily (proname,city,kind,phoneno,summary,username,password) VALUES 
    ('$name','$city','$kind','$phone','$summary','$username','$password')";
