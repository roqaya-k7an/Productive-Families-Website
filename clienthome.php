...
<html lang="en">
  <head>
    ...
    <title>Productive Families |Client Page</title>
...
?> 
                    <tbody>
                      <tr>
                        ...
                        <td><a class="aa-cart-title" href="#"><?php echo htmlentities($row['city']);?></a></td>
                        <td><?php echo htmlentities($row['street']);?></td> 
                          <td><iframe src="<?php echo htmlentities($row['location']);?>" width="300" height="250" style="border:0;" allowfullscreen="" loading="lazy"></iframe> </td>
                          
                          <td><a class="aa-add-to-cart-btn" onclick='javascript:confirmationDelete($(this));return false;' href="deladdress.php?clientid=<?php echo htmlentities($row['clientid']);?>"><fa class="fa fa-close"></fa></a></td>
                       <script>
function confirmationDelete(anchor)
{
   var conf = confirm('Are you sure to delete address');
   if(conf)
      window.location=anchor.attr("href");
}
</script>
                          <td><a href="updateaddress.php?clientid=<?php echo htmlentities($row['clientid']);?>" class="aa-add-to-cart-btn">Edit</a></td>
                      </tr>
...
?>                    
                   ...
                   <a href="addaddress.php" class="aa-browse-btn" > Add Address </a>
             ...
             <form action="">
               <div class="table-responsive">
                   ...
                   <a href="clientcart.php" class="aa-browse-btn" > View My Cart </a>
...
require 'config.php';
$clientid=$_SESSION['clientid'] ;               
$accpet='Waiting for reply';
$result = mysqli_query($con,"SELECT * FROM demand where clientid='$clientid' and accept = '$accpet' ")
or die(mysqli_error());
while($row = mysqli_fetch_array( $result )) {
// echo out the contents of each row into a table
?>
                    <tbody>
                      <tr>
                        ...
                        <td><a class="aa-cart-title" href="#"><?php echo htmlentities($row['demandno']);?></a></td>
                        <td><?php echo htmlentities($row['productname']);?></td>
                        <td><?php echo htmlentities($row['ddate']);?> </td>
                          <td> <?php echo htmlentities($row['price']);?></td>
                          <td> <?php echo htmlentities($row['unitsno']);?></td>
                         <td> <?php echo htmlentities($row['total']);?></td>
                          <td> <?php echo htmlentities($row['accept']);?></td>
                          <td><a class="aa-add-to-cart-btn" onclick='javascript:confirmationDelete($(this));return false;' href="deldemand.php?demandno=<?php echo htmlentities($row['demandno']);?>"><fa class="fa fa-close"></fa></a></td>
                       <script>
function confirmationDelete(anchor)
{
   var conf = confirm('Are you sure to cancel Request');
   if(conf)
      window.location=anchor.attr("href");
}
</script>
                          <td><a href="editdemandclient.php?demandno=<?php echo htmlentities($row['demandno']);?>" class="aa-add-to-cart-btn">Edit</a></td>
                      </tr>
                       <?php
}
...
$clientid=$_SESSION['clientid'] ;
$accept='accept';                    
$result = mysqli_query($con,"SELECT * FROM demand where clientid='$clientid' and accept='$accept' ")
or die(mysqli_error());
// display data in table
while($row = mysqli_fetch_array( $result )) {
// echo out the contents of each row into a table
                      ...
                      <tr>
                        ...
                        <td><?php echo htmlentities($row['ddate']);?> </td>
                         ...
                         <td><?php echo htmlentities($row['status']);?> </td>
                          <td><a class="aa-add-to-cart-btn" href="viewdemandclient.php?demandno=<?php echo htmlentities($row['demandno']);?>&productno=<?php echo htmlentities($row['productno']);?>">View Demand</a></td>
...
$result1= mysqli_query($con,"SELECT * FROM refuse where demandno='$dno' ")
or die(mysqli_error());
// display data in table
...
?>
                      <thead>
                        <tr>
                          <th><?php echo '<span class="color">' . $row['clientid'] . '</span>'; ?></th>
                          <th>Number</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td> <strong><?php echo '<span class="color">' . $row['cname'] . '</span>'; ?>  </strong></td>
                          <td>Name </td>
                        </tr>
                        <tr>
                          ...
                          <tr>
                          <td> <strong><?php echo '<span class="color">' . $row['address'] . '</span>'; ?>  </strong></td>
                          <td>City </td>
                        </tr>
                      ...
                      <div class="aa-payment-method" > 
                          <table class="table table-responsive">
                          <tr align="center"><td>
                      <a href="editclientdata.php?clientid=<?php echo htmlentities($row['clientid']);?>" class="aa-browse-btn">Edit Information</a></td>
                      <td>
                    <a href="signout.php?clientid=<?php echo htmlentities($row['clientid']);?>" class="aa-browse-btn">Logout</a></td> </tr></table>
